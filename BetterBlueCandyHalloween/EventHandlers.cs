...
{
    public void OnPlayerEatScp330(EatingScp330EventArgs ev)
    {
        if (ev.Candy.Kind == CandyKindID.Blue)
        {
            ...
            ev.Player.AddAhp(Plugin.Singleton.Config.ShieldBlueCandy, Plugin.Singleton.Config.ShieldBlueCandy, 0f);
            Timing.CallDelayed(Plugin.Singleton.Config.TimeBlueCandy, () =>
            {
